...
<html lang="en">
<head runat="server">
    <title>ALLSTAR SIGNS : About Us</title>
...
<body id="page3">
    ...
    <div id="menubar">
        <a href="Default.aspx">Signs</a> <a href="printing.aspx">Printing &amp; Design</a> <a href="aboutus.aspx" class="active">About Us</a> <a href="gallery.aspx">Gallery</a> <a href="contactus.aspx">Contact Us</a>
    </div>
  </section>
    <!-- content -->
    <section >
    ...
    <div class="container_24">
    	<div class="clearfix footer_lrpadding">
    	    <div class="full_row aligncenter">
    	        <p><a href="Default.aspx">Signs</a> | <a href="printing.aspx">Printing &amp; Design</a> | <a href="aboutus.aspx" class="active">About Us</a> | <a href="gallery.aspx">Gallery</a> | <a href="contactus.aspx">Contact Us</a></p>
    	    </div>
    	 <div class="full_row">
